 ...
 * This particular module will inject a {@link BlockingTaskManager}.
 ...
 */
public class BlockingSimpleMessengerModule extends AbstractModule {

	@Override
	protected void configure() {
		// This states "when I see a request for a class that implements the TaskManager interface,
		// I will provide the concrete implementation of BlockingSimpleMessengerModule".
